...
const handleSubmit = async () => {
  ...
  try {
    ...
    // Submit to store
    const result = await assignmentStore.addAssignment(assignmentData)
    ...
    router.push({
      path: '/assignments',
      query: { success: 'Assignment berhasil dibuat!' }
    })
  } catch (err) {
...
const now = new Date()
now.setSeconds(0, 0) // datetime-local nggak support detik/milisekon
        ...
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center space-x-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">Buat assignment</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="px-6 py-4 border-b border-gray-200">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-sm text-gray-500">Isi detail untuk assignment baru</p>
            </div>
          </div>
        </div>
