...
const handleSubmit = async () => {
  ...
  try {
    ...
    const wikiData = {
      ...
      content: groupForm.value.description || null,
      author: groupForm.value.author,
    }

    // Submit to store
    const result = await wikiStore.addWiki(wikiData)
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h1 class="text-2xl font-bold text-gray-900">Buat Wiki Baru</h1>
              <p class="text-sm text-gray-600">Buat wiki</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="px-6 py-4 border-b border-gray-200">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-sm text-gray-500">Isi detail untuk wiki baru</p>
            </div>
          </div>
        </div>
